    ...
    <main className="mx-auto flex min-h-screen max-w-3xl flex-col justify-center px-6 py-12">
      <div className="mb-8">
        ...
        <p className="mt-2 text-slate-600">
          ...
          <span className="font-medium text-emerald-700">incluso</span> /{" "}
          <span className="font-medium text-rose-700">não incluso</span>, marcando
          os critérios aplicáveis. Os dados ficam salvos no servidor e podem ser
      ...
      >
        ...
        <FileField
          ...
          extra={
            <a
              ...
              className="mt-2 inline-flex items-center gap-1.5 text-sm font-medium text-sky-700 hover:text-sky-900 hover:underline"
            >
        ...
        {warnings.length > 0 && (
          <ul className="mt-3 list-inside list-disc rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
        ...
        <button
          type="submit"
          disabled={loading}
          className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-slate-900 px-4 py-3 font-medium text-white transition hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-60"
        >
          {loading ? (
...
function FileField({
  ...
  return (
    <div>
      ...
      <label className="mt-3 flex cursor-pointer items-center gap-3 rounded-xl border border-dashed border-slate-300 bg-slate-50 px-4 py-3 transition hover:border-slate-400 hover:bg-slate-100">
